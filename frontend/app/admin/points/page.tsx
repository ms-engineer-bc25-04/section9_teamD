...
export default function PointsManagement() {
  ...
  return (
    <div className="min-h-screen p-4" style={{ background: "#FCF8EF" }}>
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center mb-6">
          <Button
            variant="ghost"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* イベント選択 */}
          <Card className="lg:col-span-2" style={{ background: "#fffbe9" }}>
            <CardHeader>
                              ...
                              >
                                ...
                                <div className="flex items-center gap-2 w-full sm:w-auto">
                                  <Input
                                    ...
                                    className="w-28 border-[#C3B2F7] focus:border-[#7EB8F6]"
                                  />
                                  <Button
                                    size="sm"
                                    className="bg-[#FCE98E] hover:bg-[#ffe58a] text-[#3C2A1E]"
                                    onClick={() =>
                                      handleAwardPoints(
                                        participant.id,
                                        participant.name,
        ...
        {/* 最近のポイント付与履歴 */}
        <Card className="mt-6" style={{ background: "#fffbe9" }}>
          <CardHeader>
